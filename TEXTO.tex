...
\textit{A casa do fim do mundo}, publicado pela primeira vez em 1908, é mais do que uma história de horror. Quando o
...
{\raggedleft
Max Gersh.\footnoteInSection{John C. Boland, também conhecido como Max Gersh, é autor de diversos romances e contos policiais, entre eles \textit{Wild Wood}, \textit{The Margin} e \textit{The Spy Who Knew Nothing}. Cedeu-nos gentilmente o prefácio escrito para sua edição de \emph{The House on the Borderland}, pela Perfect Crime Books, 2010.}
\par}
...
\textsc{Sou um} homem idoso.\footnoteInSection{\versal{N.E.}: A partir deste capítulo, lemos o conteúdo do manuscrito encontrado nas ruínas ao sul de Kraighten, em notas de rodapé estão os comentários de Hodgson.} Vivo aqui, nesta casa antiga, cercada de jardins enormes e descuidados.
...
presença dela,\footnoteInSection{ Uma interpolação aparentemente sem significado. Não
...
embaraçado\ldots{}\footnoteInSection{ Aqui, a caligrafia está indecifrável devido ao dano sofrido por esta parte do manuscrito. Seguem-se os
...
de uma névoa de fogo, e circundava o Sol numa velocidade abismal\ldots{}\footnoteInSection{ Mesmo a mais rigorosa análise não me permitiu decifrar mais do excerto danificado do manuscrito. Ele volta a ser
...
rápido que o anterior, o Sol começou a adquirir a aparência de um enorme cometa flamejante,\footnoteInSection{ O Eremita usa isso
...
Enquanto observava, lembrei"-me de repente, de modo inconsequente, da minha última viagem para os mundos Distantes.\footnoteInSection{ Evidentemente, 
...
Durante a noite, a Lua\footnoteInSection{ Não há mais nenhuma menção à Lua. A julgar
...
estava completamente tomada pela neve.\footnoteInSection{ Provavelmente, o ar congelado.} 
...
em todos esses milhares de anos. Mas havia a neve,\footnoteInSection{ Ver a nota
...
ficou pairando, imóvel --- um escudo enorme no céu.\footnoteInSection{ Acho curioso que,
...
enorme! Do aposento escuro atrás de mim, vinha o ruído baixo e surdo\footnoteInSection{ Neste ponto, a atmosfera capaz de transmitir 
...
numa velocidade enorme.\footnoteInSection{ Minha única suposição é que o tempo de
...
erguia"-se rumo a ela,\footnoteInSection{ Uma leitura cuidadosa do manuscrito sugere que
...
Sol morto.\footnoteInSection{ Podemos notar aqui que a Terra estava “aos poucos atravessando a imensa face do Sol morto”. Nenhuma explicação é
...
mover. Então um terrível grito suíno\footnoteInSection{ Ver a primeira nota do
capítulo ``A Estrela Verde''.} ergueu"-se na noite e, com isso, pulei da janela para o mundo congelado lá
...
flutuando. Bem lá na frente, brilhava o vasto anel cor de sangue\footnoteInSection{ Sem dúvida, a massa de bordas
...
Deus, ajude"-me! Jesus\ldots{} A porta está se abrindo lentamente\ldots{} Alg\ldots{}\footnoteInSection{E isso é tudo. A partir da palavra interrompida, é possível perceber, no manuscrito, uma fina linha de tinta que sugere o rastro
...
\textsc{Fecho o} manuscrito e olho de soslaio para Tonnison;\footnoteInSection{\versal{N.E.:} Volta a falar-nos a voz do narrador de ``A descoberta do manuscrito'', sr. Berreggnog.} ele estava sentado, mirando o nada na escuridão. Esperei um
...
\begin{verse}
A saudade abarca meu peito,\footnoteInSection{ Encontrei estas estrofes escritas a
lápis em um pedaço de papel colado atrás da folha de guarda do manuscrito.
Parecem ter sido escritas em data anterior à do documento.}\\*
